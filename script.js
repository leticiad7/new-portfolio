document.addEventListener("scroll", () => {
    ...
    // Fade-out effect: Reduce opacity as you scroll down
    bigText.style.opacity = Math.max(0, 1 - scrollY / 900); // Ensure opacity never goes below 0

    // Parallax-like effect: Slow vertical movement
    bigText.style.transform = `translateY(${scrollY * 0.05}px)`; // Slower scroll
});
